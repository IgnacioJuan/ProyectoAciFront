...
import { ActivProyection } from '../interface/ActivProyection';
...
getActiv(): Observable<ActivProyection[]> {
  return this.http.get<ActivProyection[]>(`${baserUrl}/api/actividad/listarActiv`);
}
